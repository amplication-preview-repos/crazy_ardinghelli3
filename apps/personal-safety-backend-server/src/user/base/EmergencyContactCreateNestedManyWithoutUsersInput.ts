...
@InputType()
class EmergencyContactCreateNestedManyWithoutUsersInput {
...
export { EmergencyContactCreateNestedManyWithoutUsersInput as EmergencyContactCreateNestedManyWithoutUsersInput };
